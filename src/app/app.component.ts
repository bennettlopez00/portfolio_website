...
export class AppComponent {
  ...
  carouselItems:carouselItem[] = [
    ...
    { itemLink:'https://github.com/bennettlopez00/portfolio_website', imagePath:'../assets/carousel_images/This_Website.png', itemTitle:'This Website!', itemText:'Click on the image' },
